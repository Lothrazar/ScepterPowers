...
public class ProjectileRegistry {
	...
	public static void register(){
		...
		EntityRegistry.registerModEntity(EntityLightningballBolt.class, EntityLightningballBolt.name,entityID++, ModScepterPowers.instance, trackingRange, updateFrequency, sendsVelocityUpdates);

		EntitySnowballBolt.item = new Item();
		ItemRegistry.registerItem(EntitySnowballBolt.item, EntitySnowballBolt.name_item);
		EntityRegistry.registerModEntity(EntitySnowballBolt.class, EntitySnowballBolt.name,entityID++, 			ModScepterPowers.instance, trackingRange, updateFrequency, sendsVelocityUpdates);
        
		EntityBlazeBolt.item = new Item();
		ItemRegistry.registerItem(EntityBlazeBolt.item, EntityBlazeBolt.name_item);
		EntityRegistry.registerModEntity(EntityBlazeBolt.class, EntityBlazeBolt.name,entityID++, 			ModScepterPowers.instance, trackingRange, updateFrequency, sendsVelocityUpdates);
        
		EntityDynamite.item = new Item();
		ItemRegistry.registerItem(EntityDynamite.item, EntityDynamite.name_item);
		EntityRegistry.registerModEntity(EntityDynamite.class, EntityDynamite.name,entityID++, 			ModScepterPowers.instance, trackingRange, updateFrequency, sendsVelocityUpdates);
